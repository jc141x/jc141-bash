...
export WINEPREFIX="$JCDW/prefix" && echo "Path of the wineprefix (where saves are stored -- except those stored in groot/groot-rw) is: $WINEPREFIX"; export WINEDLLOVERRIDES="mshtml=d;nvapi,nvapi64=n"; export WINE_LARGE_ADDRESS_AWARE=1;
