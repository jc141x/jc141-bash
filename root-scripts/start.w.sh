...
[ ! -e "$WHA" ] && cp /opt/jc141-bash/wha "$WHA"; [ ! -e "$VLK" ] && cp /opt/jc141-bash/vulkan "$VLK"; export WINE_LARGE_ADDRESS_AWARE=1; export WINEFSYNC=1; export WINEDLLOVERRIDES="mshtml=d;";
